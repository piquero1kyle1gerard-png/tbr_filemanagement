<x-myapplayout>
    @if (Auth::user()->hasRole('admin'))
        ...
        <div class="px-3">
            <a
                href="{{ route('admin.Dashboarding') }}"class="mb-4 mt-2 bg-blue-500 text-white text-sm px-4 py-2 rounded hover:bg-blue-700"><i
                    class="fa-solid fa-arrow-left"></i> Back</a>
        </div>

        <div class="text-center mt-5 mb-5">
            <h1 class="text-2xl font-semibold text-gray-700">Grade 7 Student List</h1>
                    ...
                    <div @click.away="open = true"
                        ...
                        <form action="{{ route('admin.add_Student') }}" method="POST" class="mt-5">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="grade_id" id="grade_id" value="29" readonly>
                    ...
                    <tbody>
                        @php
                            $filteredestudents = $estudents->filter(function ($Student) {
                                return $Student->grade->grade_level === 'Grade 7';
                            });
                        @endphp
                                            ...
                                            <div x-data="{ open: false }">
                                                ...
                                                <div x-show="open"
                                                    ...
                                                    <div @click.away="open = false"
                                                        ...
                                                        <hr class="my-4 w-full border border-black">
                                                        <form
                                                            action="{{ route('admin.update_Student', $Student->id) }}"
        ...
        <div class="text-center mt-5 mb-5">
            ...
            <div class="overflow-x-auto mt-5 max-w-3xl mx-auto">
                <table class="table-auto w-full border-collapse mx-auto bg-white shadow-lg rounded-lg text-center">
                    <thead class="bg-gray-200 text-gray-800">
                        <tr>
                            <th class="py-2 px-4 border-b text-center text-gray-600 font-semibold text-base spaced" >ID</th>
                    ...
                    <tbody>
                        ...
                        @if ($filteredestudents->isEmpty())
                            <tr>
                                <td colspan="3" class="py-3 px-4 text-center text-gray-500 text-sm">No students available</td>
                            </tr>
                        @else
                            @foreach ($filteredestudents as $Student)
                                <tr class="hover:bg-gray-100">
