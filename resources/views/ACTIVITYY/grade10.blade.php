<x-myapplayout>
    @if (Auth::user()->hasRole('admin'))
        ...
        <div class="text-center mt-5 mb-5">
            <h1 class="text-2xl font-semibold text-gray-700">Grade 10 Student List</h1>
                    ...
                    <div @click.away="open = true"
                        ...
                        <form action="{{ route('admin.add_Student') }}" method="POST" class="mt-5">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="grade_id" id="grade_id" value="32" readonly>
                    ...
                    <tbody>
                        @php
                            $filteredestudents = $estudents->filter(function($Student) {
                                return $Student->grade->grade_level === 'Grade 10';
                            });
                        @endphp

                        @if ($filteredestudents->isEmpty())
                            <tr>
                                <td colspan="4" class="py-3 px-4 text-center text-gray-500 text-sm">No data available</td>
                            </tr>
                        @else
