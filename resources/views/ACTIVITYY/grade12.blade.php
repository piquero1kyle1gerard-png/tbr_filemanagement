<x-myapplayout>
    @if (Auth::user()->hasRole('admin'))
        ...
        <div class="text-center mt-5 mb-5">
            <h1 class="text-2xl font-semibold text-gray-700">Grade 12 Student List</h1>
                    ...
                    <div @click.away="open = true"
                        ...
                        <form action="{{ route('admin.add_Student') }}" method="POST" class="mt-5">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="hidden" name="grade_id" id="grade_id" value="34" readonly>
                    ...
                    <tbody>
                        @php
                            $filteredestudents = $estudents->filter(function($Student) {
                                return $Student->grade->grade_level === 'Grade 12';
                            });
                        @endphp
